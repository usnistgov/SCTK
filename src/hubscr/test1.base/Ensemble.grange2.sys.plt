...
plot "Ensemble.grange2.sys.mean" using 2:1 title "Mean Speaker Word Error Rate (%)" with lines,\
     ...
     "Ensemble.grange2.sys.dat" using 2:1 "%lf%lf" title "2347-a",\
     "Ensemble.grange2.sys.dat" using 2:1 "%lf%*s%lf" title "2347-b",\
     "Ensemble.grange2.sys.dat" using 2:1 "%lf%*s%*s%lf" title "3129-a",\
     "Ensemble.grange2.sys.dat" using 2:1 "%lf%*s%*s%*s%lf" title "3129-b"
